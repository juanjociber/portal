...
$archivo = $_SERVER['DOCUMENT_ROOT'].'/mycloud/portal/cotizador/plantillas/cotizacion_productos.xlsx';
...
header('Content-Disposition: attachment;filename="'. 'cotizacion_productos_v1.xlsx"');
