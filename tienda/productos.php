                                ...
                                <div class="card h-100 border-0">';
                                    ...
                                    //if($row2['stock']>0){
                                        ...
                                        <div class="col-12 container-wa text-end">
                                            <h1 class="link-wa"><a class="text-decoration-none" href="https://wa.me/51982827525?text=https%3A%2F%2Fgpemsac.com%2Fproducto%2F'.$row2['seourl'].'%0D%0A%0D%0AHola%2C+estoy+interesado+en+cotizar+este+producto.+Puede+ayudarme%3F" target="_blank"><i class="fab fa-whatsapp-square"></i></a></h1>
                                        </div>
