...
<body style="margin-top:5rem">
    ...
    <div class="container">
        ...
        <div class="row mb-2">  
            ...
            <div class="col-12 pl-4 mb-2 border-bottom">
                <p class="font-weight-bold">1.5 - Amabilidad en la atención.</p>
                <div class="row pl-4 mb-2">
                    <div class="col-12 col-md-2 form-check form-check-inline">
        ...
        <div class="row mb-5">
            <div class="col-12 text-center mb-2">
                <button type="button" class="btn btn-primary btn-lg" onclick="fnEnviarEncuestaServicios(); return false;">Enviar respuestas</button>
            </div>
        </div>
    </div>
